...
const SEED_DESTINATIONS = [
  ...
  },
  {
    ...
    categorySlug: "forests",
    district: "Balod",
    tagline: "A Serene Lakeside Retreat",
    latitude: 20.6214,
    longitude: 81.2584,
    heroImage: "/chitrakote.png",
    story: "Tandula Dam is built on the Tandula River in Balod district. The dam has a magnificent lake area surrounded by lush green forests, making it a highly popular weekend getaway and eco-tourism spot.",
    bestTime: "October to March",
    safety: "Avoid swimming in deep reservoir waters.",
    ecoGuidance: "Do not litter around the lake or dam catchment area."
  },
  {
    slug: "girodhpuri-dham",
    name: "Girodhpuri Dham",
    categorySlug: "temples",
    district: "Baloda Bazar",
    tagline: "The Spiritual Beacon of Satnam",
    latitude: 21.6883,
    longitude: 82.5284,
    heroImage: "/sirpur.png",
    story: "Girodhpuri Dham is the birthplace of Guru Ghasidas, the founder of the Satnami sect. The site features the iconic Jait Khambh tower, standing taller than the Qutub Minar, as a symbol of peace and equality.",
    bestTime: "All year round",
    safety: "Wear comfortable walking shoes for climbing.",
    ecoGuidance: "Maintain quietness and cleanliness inside the complex."
  },
  {
    slug: "tatapani-hot-springs",
    name: "Tatapani Hot Springs",
    categorySlug: "forests",
    district: "Balrampur",
    tagline: "Geothermal Wonder of Chhattisgarh",
    latitude: 23.6834,
    longitude: 83.4750,
    heroImage: "/tirathgarh.png",
    story: "Tatapani is famous for its natural hot sulfur springs that flow continuously throughout the year. The water is believed to have medicinal properties for skin diseases.",
    bestTime: "November to February",
    safety: "Do not touch the boiling water directly at the source vents.",
    ecoGuidance: "Do not throw soap or chemical products into the spring pools."
  },
  {
    ...
    categorySlug: "temples",
    district: "Bemetara",
    tagline: "An Ancient Riverside Sanctuary",
    latitude: 21.7834,
    longitude: 81.5500,
    heroImage: "/sirpur.png",
    story: "This historic temple dedicated to Maa Bhadrakali is situated on the picturesque confluence of the Shivnath and Kharun rivers. It holds immense spiritual significance for local communities.",
    bestTime: "October to March",
    safety: "Keep safe distance from the river bank during monsoon season.",
    ecoGuidance: "Respect religious traditions and local dress code."
  },
  {
    slug: "lanka-waterfall",
    name: "Lanka Waterfall",
    categorySlug: "waterfalls",
    district: "Bijapur",
    tagline: "The Roaring Cascade of Abujhmad",
    latitude: 19.1234,
    longitude: 80.8500,
    heroImage: "/tirathgarh.png",
    story: "Lanka Waterfall is one of the highest and most remote waterfalls in the state, located deep within the wilderness of Bijapur. The water plunges from a staggering height of 150 feet.",
    bestTime: "September to January",
    safety: "Travel only with a local guide; avoid steep rocky descents.",
    ecoGuidance: "Strictly follow 'Leave No Trace' policies in this pristine forest zone."
  },
  {
    ...
    categorySlug: "temples",
    district: "Dantewada",
    tagline: "The Sacred Shakti Peeth of Bastar",
    latitude: 18.9000,
    longitude: 81.3500,
    heroImage: "/buddha_temple.jpg",
    story: "Built by the Chalukya kings in the 14th century, this ancient temple is one of the 51 sacred Shakti Peeths of India, dedicated to Goddess Danteshwari, the ancestral deity of the Bastar region.",
    bestTime: "All year round",
    safety: "Expect heavy crowds during Dussehra festival.",
    ecoGuidance: "Strictly no photography allowed inside the inner sanctum."
  },
  {
    slug: "deobaloda-temple",
    name: "Deobaloda Shiva Temple",
    categorySlug: "temples",
    district: "Durg",
    tagline: "13th-Century Stone Heritage",
    latitude: 21.2167,
    longitude: 81.4333,
    heroImage: "/madwa_mahal.jpg",
    story: "Deobaloda features an ancient 13th-century Kalachuri Shiva temple with a unique adjacent stepwell. The temple exhibits exquisite stone carvings of deities and mythological creatures.",
    bestTime: "All year round",
    safety: "Be careful of slippery stone steps leading to the ancient stepwell.",
    ecoGuidance: "Preserve the ancient sandstone carvings; do not touch or deface the structures."
  },
  {
    ...
    categorySlug: "temples",
    district: "Gariaband",
    tagline: "The World's Largest Natural Shivling",
    latitude: 20.6500,
    longitude: 81.9500,
    heroImage: "/kaal_bhairav.png",
    story: "Bhuteshwar Mahadev is a massive natural monolithic granite rock that acts as a Shivling. Remarkably, local forest department measurements confirm that it increases in height and width every year.",
    bestTime: "July to March",
    safety: "Walk carefully on the slippery granite rock slopes.",
    ecoGuidance: "Do not paint or write on the sacred natural rock formation."
  },
  {
    slug: "kabir-chabutra",
    name: "Kabir Chabutra",
    ...
    tagline: "The Meditative Retreat of Saint Kabir",
    latitude: 22.7500,
    longitude: 81.7500,
    heroImage: "/barnawapara.png",
    story: "Kabir Chabutra is a serene spiritual spot where the legendary saint Kabir is believed to have meditated. It is situated on the scenic border corridor of Chhattisgarh and Madhya Pradesh.",
    bestTime: "October to March",
    safety: "Watch out for wild monkeys and keep food items secured.",
    ecoGuidance: "Maintain absolute silence and keep the surrounding woodlands clean."
  },
  {
    slug: "nakta-mandir",
    name: "Nakta Mandir",
    ...
    tagline: "The Unfinished Masterpiece of Janjgir",
    latitude: 22.0167,
    longitude: 82.5833,
    heroImage: "/siddhi_vinayak.png",
    story: "Also known as the Vishnu Temple of Janjgir, this 12th-century structure is called Nakta Mandir ('maimed temple') because it was left unfinished due to a mythological contest between sculptors.",
    bestTime: "All year round",
    safety: "Safe for families; mind the low door frames.",
    ecoGuidance: "Respect the ancient ASI-protected structural site."
  },
  {
    slug: "sogara-ashram",
    name: "Sogara Ashram",
    categorySlug: "temples",
    district: "Jashpur",
    tagline: "The Spiritual Sanctuary of Jashpur",
    latitude: 22.8834,
    longitude: 84.1500,
    heroImage: "/buddha_temple.jpg",
    story: "Sogara Ashram is a globally renowned spiritual retreat center surrounded by pristine gardens and quiet forests, offering meditation courses and serving as a beacon of social service.",
    bestTime: "All year round",
    safety: "Follow the peaceful guidelines of the resident yogis.",
    ecoGuidance: "Do not throw litter or disturb the ashram's organic gardens."
  },
  {
    slug: "gadiya-mountain",
    name: "Gadiya Mountain",
    categorySlug: "forests",
    district: "Kanker",
    tagline: "The Hilltop Fort of the Dharma Rajas",
    latitude: 20.2667,
    longitude: 81.4833,
    heroImage: "/bhoramdeo_wildlife.jpg",
    story: "Gadiya Mountain served as the capital of the Kanker kings. It features a historic hilltop fort and a sacred pond that never dries up, offering panoramic views of the Kanker valley below.",
    bestTime: "October to February",
    safety: "The trek involves climbing 800+ stone steps; carry sufficient drinking water.",
    ecoGuidance: "Do not throw waste in the hilltop water reservoir."
  },
  {
    slug: "keshkal-valley",
    name: "Keshkal Valley",
    categorySlug: "forests",
    district: "Kondagaon",
    tagline: "The Lush Hairpin Gateway of Bastar",
    latitude: 20.0834,
    longitude: 81.6000,
    heroImage: "/chilphi_valley.jpg",
    story: "Keshkal Ghat features a spectacular mountain pass with 12 sharp hairpin bends cutting through lush deciduous forests. It serves as the magnificent geographic gateway to the Bastar plateau.",
    bestTime: "July to February",
    safety: "Drive extremely slowly on the steep hairpin curves; avoid parking on blind turns.",
    ecoGuidance: "Strictly avoid feeding wild monkeys along the valley viewpoints."
  },
  {
    slug: "kendai-waterfall",
    name: "Kendai Waterfall",
    categorySlug: "waterfalls",
    district: "Korba",
    tagline: "The Cascading Torrent of Bango",
    latitude: 22.4834,
    longitude: 82.5500,
    heroImage: "/ranidhara_waterfall.jpg",
    story: "Kendai is a stunning 75-foot waterfall located in the Korba district along the Bilaspur-Ambikapur highway. It plunges over a massive rocky cliff surrounded by dense green forest foliage.",
    bestTime: "July to November",
    safety: "Do not attempt to go near the plunge pool during heavy monsoon currents.",
    ecoGuidance: "Dispose of all food waste in bins provided near the viewing bridge."
  },
  {
    slug: "jhumka-island-udhyan",
    name: "Jhumka Island Udhyan",
    categorySlug: "forests",
    district: "Koriya",
    tagline: "The Lakeside Island Escape",
    latitude: 23.2500,
    longitude: 82.5333,
    heroImage: "/gangrel.png",
    story: "Situated in the middle of the massive Jhumka Reservoir in Baikunthpur, this beautifully developed island park features manicured gardens, children's play areas, and relaxing boat cruises.",
    bestTime: "October to April",
    safety: "Wear lifejackets at all times during boat transit to the island.",
    ecoGuidance: "Help keep the island plastic-free; carry all containers back to the mainland."
  },
  {
    slug: "ramdaha-waterfall",
    name: "Ramdaha Waterfall",
    categorySlug: "waterfalls",
    district: "Manendragarh-Chirmiri-Bharatpur",
    tagline: "A Thundering Forest Cascade",
    latitude: 23.3834,
    longitude: 82.1500,
    heroImage: "/ghaghi_waterfall.jpg",
    story: "Ramdaha Waterfall is a scenic, thundering cascade surrounded by thick forests. The water flows over massive rocky ledges, creating a natural pool that is highly popular for eco-picnics.",
    bestTime: "August to December",
    safety: "Stay well clear of the deep water whirlpool zones.",
    ecoGuidance: "Strictly avoid littering or campfires in the surrounding forest reserve."
  },
  {
    slug: "ambagarh-chowki-fort",
    name: "Ambagarh Chowki Fort",
    categorySlug: "temples",
    district: "Mohla-Manpur-Ambagarh Chowki",
    tagline: "The Historic Citadel of the Borderlands",
    latitude: 20.7834,
    longitude: 80.7500,
    heroImage: "/ratanpur_fort.png",
    story: "Ambagarh Chowki features the ruins of a historic defensive fort built on a hilltop. It served as a strategic outpost for local chieftains to monitor regional trade corridors.",
    bestTime: "October to February",
    safety: "Wear sturdy shoes for trekking up the ancient rocky fort trail.",
    ecoGuidance: "Do not touch or damage the ancient brick and stone defensive ruins."
  },
  {
    slug: "madku-dweep",
    name: "Madku Dweep",
    categorySlug: "temples",
    district: "Mungeli",
    tagline: "The Archaeological River Island",
    latitude: 21.6334,
    longitude: 81.8833,
    heroImage: "/sw.js",
    story: "Madku Dweep is a peaceful river island in the Shivnath River. Archaeological excavations have unearthed 19 ancient temples dating back to the 10th-11th century Kalachuri period, alongside historic stone inscriptions.",
    bestTime: "November to March",
    safety: "Be careful of wet clay banks near the Shivnath river crossing.",
    ecoGuidance: "Respect the ongoing archaeological excavations and do not climb on exposed ruins."
  },
  {
    slug: "handawada-waterfall",
    name: "Handawada Waterfall",
    categorySlug: "waterfalls",
    district: "Narayanpur",
    tagline: "The Deep Jungle Wonder of Abujhmad",
    latitude: 19.3500,
    longitude: 81.1833,
    heroImage: "/fish_point.jpg",
    story: "Hidden deep inside the isolated forests of Abujhmad, Handawada Waterfall is one of Chhattisgarh's most spectacular and untouched natural wonders. The waterfall drops over 100 feet into a pristine gorge.",
    bestTime: "September to December",
    safety: "Requires a strenuous forest trek; travel only in groups with authorized local guides.",
    ecoGuidance: "Preserve the pristine Abujhmad eco-sensitive zone; zero plastic policy."
  },
  {
    slug: "kabra-pahar",
    name: "Kabra Pahar Rock Art",
    categorySlug: "forests",
    district: "Raigarh",
    tagline: "Chhattisgarh's Prehistoric Canvas",
    latitude: 21.8833,
    longitude: 83.4000,
    heroImage: "/achanakmar.png",
    story: "Kabra Pahar contains a series of ancient rock shelters featuring red ochre rock paintings created by prehistoric humans. The drawings depict animal figures, hunting scenes, and geometric patterns.",
    bestTime: "October to March",
    safety: "Wear good hiking shoes for climbing the rocky steep hillside.",
    ecoGuidance: "Do not touch or spray water on the ancient prehistoric drawings."
  },
  {
    slug: "purkhouti-muktangan",
    name: "Purkhouti Muktangan",
    categorySlug: "forests",
    district: "Raipur",
    tagline: "An Immersive Open-Air Tribal Museum",
    latitude: 21.1667,
    longitude: 81.7833,
    heroImage: "/sirpur.png",
    story: "Spread over 130 acres in Naya Raipur, Purkhouti Muktangan is a magnificent open-air museum displaying lifelike models of Chhattisgarh's tribal homes, traditional folk art, and major tourist monuments.",
    bestTime: "All year round",
    safety: "Ideal for all ages; carry hats or umbrellas during summer afternoons.",
    ecoGuidance: "Help keep the cultural park clean; use designated recycling bins."
  },
  {
    slug: "maa-bambleshwari-temple",
    name: "Maa Bambleshwari Temple",
    categorySlug: "temples",
    district: "Rajnandgaon",
    tagline: "The Hilltop Shrine of Dongargarh",
    latitude: 20.8250,
    longitude: 80.7667,
    heroImage: "/kaal_bhairav.png",
    story: "Perched atop a 1,600-foot hill in Dongargarh, this highly revered shrine is dedicated to Bagalamukhi Devi (Maa Bambleshwari). It is a major pilgrimage destination drawing millions of devotees annually.",
    bestTime: "All year round (Vibrant during Navratri)",
    safety: "Optionally use the ropeway service to avoid climbing the 1,000+ stairs.",
    ecoGuidance: "Do not litter flowers or plastics along the hilltop path."
  },
  {
    slug: "chandrahasini-devi-temple",
    name: "Chandrahasini Devi Temple",
    categorySlug: "temples",
    district: "Sakti",
    tagline: "The Sacred Riverside Sanctuary of Sakti",
    latitude: 21.6983,
    longitude: 83.2384,
    heroImage: "/sw.js",
    story: "Chandrahasini Devi Temple is situated on the picturesque banks of the Mahanadi River in Sakti district. The temple is dedicated to Maa Chandrahasini, featuring unique mythological caves and dioramas.",
    bestTime: "All year round",
    safety: "Be careful of slippery stone steps near the Mahanadi river ghats.",
    ecoGuidance: "Dispose of ritual offerings in eco-friendly bins provided near the temple."
  },
  {
    slug: "pujaripali-temple",
    name: "Pujaripali Temple Complex",
    categorySlug: "temples",
    district: "Sarangarh-Bilaigarh",
    tagline: "The Brick Monuments of Sarangarh",
    latitude: 21.5500,
    longitude: 83.1500,
    heroImage: "/ram_tekri.png",
    story: "Pujaripali is an ancient village famous for its historical brick temples, including the Gopalji Temple, dating back to the Gupta and post-Gupta eras. It showcases intricate brick masonry and carvings.",
    bestTime: "October to March",
    safety: "Mind your step around loose historical stone work.",
    ecoGuidance: "Respect the archaeological structures; strictly no graffiti."
  },
  {
    slug: "duduma-waterfall",
    name: "Duduma Waterfall",
    categorySlug: "waterfalls",
    district: "Sukma",
    tagline: "The Majestic Plunge of Sukma Border",
    latitude: 18.5200,
    longitude: 81.8200,
    heroImage: "/tirathgarh.png",
    story: "Located on the border corridor of Sukma district, Duduma Waterfall is a magnificent cascade formed by the Machkund River. The water drops over 175 meters into a canyon.",
    bestTime: "September to January",
    safety: "Stay behind the viewpoints; the gorge has steep drop-offs.",
    ecoGuidance: "Help preserve the surrounding pristine riverine forest reserve."
  },
  {
    slug: "kudargarh-temple",
    name: "Kudargarh Maa Kudargarhi Temple",
    categorySlug: "temples",
    district: "Surajpur",
    tagline: "The Hilltop Shrine of Surajpur",
    latitude: 23.4500,
    longitude: 82.9500,
    heroImage: "/sw.js",
    story: "Kudargarh is a highly revered hilltop pilgrimage center dedicated to Maa Kudargarhi. The shrine sits atop a steep hill, offering breathtaking panoramic views of the Surajpur countryside.",
    bestTime: "October to April",
    safety: "Take regular breaks while climbing the hilltop pilgrim stairs.",
    ecoGuidance: "Keep the forest hills clean; pack your plastic water bottles back down."
  },
  {
    slug: "gandai-pandaria-temple",
    name: "Gandai Pandaria Shiva Temple",
    categorySlug: "temples",
    district: "Khairagarh-Chhuikhadan-Gandai",
    tagline: "An 11th-Century Architectural Gem",
    latitude: 21.6500,
    longitude: 81.1200,
    heroImage: "/deobaloda-temple.jpg",
    story: "Also known as the Devalaya of Gandai, this ancient 11th-century Shiva temple is a masterpiece of Kalachuri architecture, constructed with finely carved red sandstone displaying intricate details.",
    bestTime: "All year round",
    safety: "Mind the low doorways while exploring the stone sanctum.",
    ecoGuidance: "Preserve the ancient stone carvings; do not touch or deface the structures."
  }
];
