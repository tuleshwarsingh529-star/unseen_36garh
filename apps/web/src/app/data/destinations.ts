...
export const DESTINATIONS: Destination[] = [
  ...
  },
  {
    ...
    coordinates: { lat: 20.6214, lng: 81.2584, mapX: 45, mapY: 65 },
    heroImage: "/chitrakote.png",
    storyTitle: "Balod's Forest Lake",
    ...
    timings: "08:00 AM - 06:00 PM",
    routes: "Accessible by road from Balod or Durg.",
    bestTime: "October to March",
    seasonalAdvice: "Best visited in winter when water is calm and pleasant.",
    safety: "Avoid swimming in deep reservoir waters.",
    nearby: ["Maitri Bagh"],
    localInsights: "The garden area offers nice sunset views.",
    ecoGuidance: "Do not litter around the lake or dam catchment area.",
    biodiversityScore: 70,
    crowdCapacity: 300,
    rating: 4.4,
    localFood: "Snacks from local vendors.",
    photographySpots: "Sunset from the dam wall."
  },
  {
    id: "girodhpuri-dham",
    ...
    coordinates: { lat: 21.6883, lng: 82.5284, mapX: 68, mapY: 48 },
    heroImage: "/sirpur.png",
    storyTitle: "Birthplace of Guru Ghasidas",
    ...
    timings: "06:00 AM - 08:00 PM",
    routes: "Accessible from Baloda Bazar or Raipur.",
    bestTime: "All year round",
    seasonalAdvice: "Pilgrims flock here during the annual fair in December/January.",
    safety: "Wear comfortable walking shoes for climbing.",
    nearby: ["Sirpur Monuments"],
    localInsights: "The view from the top of Jait Khambh is spectacular.",
    ecoGuidance: "Maintain quietness and cleanliness inside the complex.",
    biodiversityScore: 50,
    crowdCapacity: 1000,
    rating: 4.8,
    localFood: "Vegetarian food at bhojnalayas.",
    photographySpots: "Jait Khambh against the clear blue sky."
  },
  {
    id: "tatapani-hot-springs",
    name: "Tatapani Hot Springs",
    category: "forests",
    district: "Balrampur",
    tagline: "Geothermal Wonder of Chhattisgarh",
    coordinates: { lat: 23.6834, lng: 83.4750, mapX: 79, mapY: 5 },
    heroImage: "/tirathgarh.png",
    storyTitle: "The Healing Geothermal Springs",
    ...
    routes: "Located in Balrampur district along the Ambikapur-Ramanujganj road.",
    bestTime: "November to February",
    seasonalAdvice: "Winters are best as the hot water is highly soothing.",
    safety: "Do not touch the boiling water directly at the source vents.",
    nearby: ["Dipadih Ruins"],
    localInsights: "Separate bathing areas have been constructed for tourists.",
    ecoGuidance: "Do not throw soap or chemical products into the spring pools.",
    biodiversityScore: 65,
    crowdCapacity: 250,
    rating: 4.5,
    localFood: "Basic tea and snack stalls.",
    photographySpots: "The steam rising from the geothermal vents at dawn."
  },
  {
    ...
    coordinates: { lat: 21.7834, lng: 81.5500, mapX: 43, mapY: 46 },
    heroImage: "/sirpur.png",
    storyTitle: "Temple on River Confluence",
    ...
    timings: "06:00 AM - 08:00 PM",
    routes: "Accessible by road from Bemetara or Raipur.",
    bestTime: "October to March",
    seasonalAdvice: "Confluence looks beautiful post-monsoon.",
    safety: "Keep safe distance from the river bank during monsoon season.",
    nearby: ["Deobaloda Temple"],
    localInsights: "Attend the evening aarti for a peaceful experience.",
    ecoGuidance: "Respect religious traditions and local dress code.",
    biodiversityScore: 55,
    crowdCapacity: 200,
    rating: 4.3,
    localFood: "Prasad and local temple sweets.",
    photographySpots: "The temple reflections in the river confluence."
  },
  {
    id: "lanka-waterfall",
    ...
    coordinates: { lat: 19.1234, lng: 80.8500, mapX: 20, mapY: 82 },
    heroImage: "/tirathgarh.png",
    storyTitle: "Abujhmad's Highest Cascade",
    ...
    timings: "08:00 AM - 04:00 PM",
    routes: "Highly remote forest routes; requires 4x4 or trekking.",
    bestTime: "September to January",
    seasonalAdvice: "Avoid travel during peak monsoon due to river flooding.",
    safety: "Travel only with a local guide; avoid steep rocky descents.",
    nearby: ["Bhairamgarh Sanctuary"],
    localInsights: "This waterfall remains untouched by commercialization.",
    ecoGuidance: "Strictly follow 'Leave No Trace' policies in this pristine forest zone.",
    biodiversityScore: 95,
    crowdCapacity: 50,
    rating: 4.8,
    localFood: "Carry your own dry rations and water.",
    photographySpots: "The full vertical plunge from the rocky gorge bottom."
  },
  {
    ...
    coordinates: { lat: 18.9000, lng: 81.3500, mapX: 38, mapY: 85 },
    heroImage: "/buddha_temple.jpg",
    storyTitle: "The Ancient Shakti Peeth",
    ...
    routes: "Easily accessible from Jagdalpur or Dantewada town.",
    bestTime: "All year round",
    seasonalAdvice: "Dussehra is extremely vibrant with historic tribal processions.",
    safety: "Expect heavy crowds during Dussehra festival.",
    nearby: ["Barsur Temple"],
    localInsights: "Observe the unique black stone idol of the Goddess.",
    ecoGuidance: "Strictly no photography allowed inside the inner sanctum.",
    biodiversityScore: 60,
    crowdCapacity: 1000,
    rating: 4.9,
    localFood: "Traditional prasad and local Bastar snacks.",
    photographySpots: "The majestic wooden temple gateway."
  },
  {
    id: "deobaloda-temple",
    ...
    coordinates: { lat: 21.2167, lng: 81.4333, mapX: 40, mapY: 52 },
    heroImage: "/madwa_mahal.jpg",
    storyTitle: "Kalachuri Era Stepwell Temple",
    ...
    timings: "06:00 AM - 07:00 PM",
    routes: "Located in Bhilai/Durg region, close to NH 53.",
    bestTime: "All year round",
    seasonalAdvice: "Shivratri is celebrated with special prayers and local lighting.",
    safety: "Be careful of slippery stone steps leading to the ancient stepwell.",
    nearby: ["Maitri Bagh"],
    localInsights: "Legend says the stepwell connects to a subterranean passage.",
    ecoGuidance: "Preserve the ancient sandstone carvings; do not touch or deface the structures.",
    biodiversityScore: 50,
    crowdCapacity: 250,
    rating: 4.5,
    localFood: "Local Bhilai street food.",
    photographySpots: "The carved pillars showing mythological legends."
  },
  {
    id: "bhuteshwar-mahadev",
    name: "Bhuteshwar Mahadev",
    category: "temples",
    district: "Gariaband",
    tagline: "The World's Largest Natural Shivling",
    coordinates: { lat: 20.6500, lng: 81.9500, mapX: 55, mapY: 63 },
    heroImage: "/kaal_bhairav.png",
    storyTitle: "The Growing Monolith",
    ...
    timings: "06:00 AM - 08:00 PM",
    routes: "Located near Gariaband town, surrounded by forests.",
    bestTime: "July to March",
    seasonalAdvice: "Monsoons bring lush green views around the monolith.",
    safety: "Walk carefully on the slippery granite rock slopes.",
    nearby: ["Jatmai Temple"],
    localInsights: "Locals celebrate heavily during Sawan month (July/August).",
    ecoGuidance: "Do not paint or write on the sacred natural rock formation.",
    biodiversityScore: 75,
    crowdCapacity: 800,
    rating: 4.8,
    localFood: "Local forest produce snacks.",
    photographySpots: "The giant monolithic rock framed against the forest hills."
  },
  {
    id: "kabir-chabutra",
    name: "Kabir Chabutra",
    ...
    coordinates: { lat: 22.7500, lng: 81.7500, mapX: 47, mapY: 26 },
    heroImage: "/barnawapara.png",
    storyTitle: "The Seat of Kabir",
    ...
    timings: "06:00 AM - 06:00 PM",
    routes: "Accessible from Pendra Road or Amarkantak.",
    bestTime: "October to March",
    seasonalAdvice: "Pleasant misty weather during winter months.",
    safety: "Watch out for wild monkeys and keep food items secured.",
    nearby: ["Achanakmar Sanctuary"],
    localInsights: "Locals drink the sweet water of the nearby Kabir spring.",
    ecoGuidance: "Maintain absolute silence and keep the surrounding woodlands clean.",
    biodiversityScore: 80,
    crowdCapacity: 200,
    rating: 4.6,
    localFood: "Roadside tea and hot pakoras.",
    photographySpots: "The historic brick platform under the massive Banyan tree."
  },
  {
    id: "nakta-mandir",
    name: "Nakta Mandir",
    ...
    coordinates: { lat: 22.0167, lng: 82.5833, mapX: 69, mapY: 34 },
    heroImage: "/siddhi_vinayak.png",
    storyTitle: "The Maimed Vishnu Temple",
    ...
    routes: "Located in Janjgir town; easily accessible by road/rail.",
    bestTime: "All year round",
    seasonalAdvice: "Best visited during cooler winter months.",
    safety: "Safe for families; mind the low door frames.",
    nearby: ["Ratanpur Fort"],
    localInsights: "Observe the intricate carvings of deities on the temple plinth.",
    ecoGuidance: "Respect the ancient ASI-protected structural site.",
    biodiversityScore: 40,
    crowdCapacity: 300,
    rating: 4.4,
    localFood: "Champa's famous sweets and snacks.",
    photographySpots: "The unique empty lintel and relief carvings of the temple facade."
  },
  {
    id: "sogara-ashram",
    name: "Sogara Ashram",
    ...
    coordinates: { lat: 22.8834, lng: 84.1500, mapX: 88, mapY: 12 },
    heroImage: "/buddha_temple.jpg",
    storyTitle: "Yogic Oasis in Jashpur Hills",
    ...
    timings: "06:00 AM - 07:00 PM",
    routes: "Located near Jashpur Nagar.",
    bestTime: "All year round",
    seasonalAdvice: "Jashpur's cool climate makes this pleasant even in summer.",
    safety: "Follow the peaceful guidelines of the resident yogis.",
    nearby: ["Kotebira Dham"],
    localInsights: "Sample the ashram's organic herbal tea.",
    ecoGuidance: "Do not throw litter or disturb the ashram's organic gardens.",
    biodiversityScore: 60,
    crowdCapacity: 400,
    rating: 4.7,
    localFood: "Simple vegetarian satvik food.",
    photographySpots: "The quiet meditation halls surrounded by blooming flowers."
  },
  {
    id: "gadiya-mountain",
    ...
    coordinates: { lat: 20.2667, lng: 81.4833, mapX: 42, mapY: 71 },
    heroImage: "/bhoramdeo_wildlife.jpg",
    storyTitle: "Capital of Kanker Kings",
    ...
    routes: "Located near Kanker town; requires climbing stairs.",
    bestTime: "October to February",
    seasonalAdvice: "Start climbing early in the morning to avoid the heat.",
    safety: "The trek involves climbing 800+ stone steps; carry sufficient drinking water.",
    nearby: ["Malanjhkudum Waterfall"],
    localInsights: "The pond at the top is called Sonai-Rupai after two royal princesses.",
    ecoGuidance: "Do not throw waste in the hilltop water reservoir.",
    biodiversityScore: 82,
    crowdCapacity: 300,
    rating: 4.6,
    localFood: "Traditional tribal snacks at the base.",
    photographySpots: "Golden hour view of Kanker town from the edge of the fort ruins."
  },
  {
    id: "keshkal-valley",
    name: "Keshkal Valley",
    ...
    coordinates: { lat: 20.0834, lng: 81.6000, mapX: 46, mapY: 74 },
    heroImage: "/chilphi_valley.jpg",
    storyTitle: "The Twelve Hairpins Ghat",
    ...
    timings: "Open 24 hours",
    routes: "Located on National Highway 30 between Raipur and Jagdalpur.",
    bestTime: "July to February",
    seasonalAdvice: "Lush green and covered in fog during the monsoon.",
    safety: "Drive extremely slowly on the steep hairpin curves; avoid parking on blind turns.",
    nearby: ["Tatama Devi Temple"],
    localInsights: "There is a temple of Keshkal Devi at the top of the ghat for safe travels.",
    ecoGuidance: "Strictly avoid feeding wild monkeys along the valley viewpoints.",
    biodiversityScore: 85,
    crowdCapacity: 500,
    rating: 4.8,
    localFood: "Roadside tea, roasted corn, and dhabas.",
    photographySpots: "The valley view from the 7th hairpin curve deck."
  },
  {
    id: "kendai-waterfall",
    ...
    coordinates: { lat: 22.4834, lng: 82.5500, mapX: 68, mapY: 21 },
    heroImage: "/ranidhara_waterfall.jpg",
    storyTitle: "Korba's Thundering Waterfall",
    ...
    timings: "08:00 AM - 05:00 PM",
    routes: "Located in the Katghora block of Korba district.",
    bestTime: "July to November",
    seasonalAdvice: "Best visited right after the monsoons when the fall is fully active.",
    safety: "Do not attempt to go near the plunge pool during heavy monsoon currents.",
    nearby: ["Hasdeo Bango Dam"],
    localInsights: "A small cave exists behind the waterfall where ascetics used to meditate.",
    ecoGuidance: "Dispose of all food waste in bins provided near the viewing bridge.",
    biodiversityScore: 80,
    crowdCapacity: 200,
    rating: 4.6,
    localFood: "Local tea and snacks from highway stalls.",
    photographySpots: "The bridge directly in front of the waterfall for panoramic landscape shots."
  },
  {
    id: "jhumka-island-udhyan",
    name: "Jhumka Island Udhyan",
    category: "forests",
    district: "Koriya",
    tagline: "The Lakeside Island Escape",
    coordinates: { lat: 23.2500, lng: 82.5333, mapX: 52, mapY: 15 },
    heroImage: "/gangrel.png",
    storyTitle: "Island Park in Jhumka Lake",
    ...
    routes: "Boat transit from the Jhumka Dam boat club in Baikunthpur.",
    bestTime: "October to April",
    seasonalAdvice: "Pleasant afternoon breezes during winter months.",
    safety: "Wear lifejackets at all times during boat transit to the island.",
    nearby: ["Amritdhara Falls"],
    localInsights: "Rent a pedal boat to explore the quiet corners of the lake.",
    ecoGuidance: "Help keep the island plastic-free; carry all containers back to the mainland.",
    biodiversityScore: 70,
    crowdCapacity: 300,
    rating: 4.4,
    localFood: "Fast food at the boat club canteen.",
    photographySpots: "The suspension bridge connecting to the boat dock at sunset."
  },
  {
    id: "ramdaha-waterfall",
    name: "Ramdaha Waterfall",
    category: "waterfalls",
    district: "Manendragarh-Chirmiri-Bharatpur",
    tagline: "A Thundering Forest Cascade",
    coordinates: { lat: 23.3834, lng: 82.1500, mapX: 40, mapY: 12 },
    heroImage: "/ghaghi_waterfall.jpg",
    storyTitle: "The Banas River Cascade",
    ...
    timings: "08:00 AM - 05:00 PM",
    routes: "Located in the Bharatpur block, accessible from Manendragarh.",
    bestTime: "August to December",
    seasonalAdvice: "Flow is strongest post-monsoon from September to November.",
    safety: "Stay well clear of the deep water whirlpool zones.",
    nearby: ["Amritdhara Falls"],
    localInsights: "The location is extremely quiet and popular for birdwatching.",
    ecoGuidance: "Strictly avoid littering or campfires in the surrounding forest reserve.",
    biodiversityScore: 88,
    crowdCapacity: 150,
    rating: 4.7,
    localFood: "Carry your own food; no vendors are present.",
    photographySpots: "The tiered rocky layers showing the water dispersion."
  },
  {
    id: "ambagarh-chowki-fort",
    name: "Ambagarh Chowki Fort",
    category: "temples",
    district: "Mohla-Manpur-Ambagarh Chowki",
    tagline: "The Historic Citadel of the Borderlands",
    coordinates: { lat: 20.7834, lng: 80.7500, mapX: 20, mapY: 60 },
    heroImage: "/ratanpur_fort.png",
    storyTitle: "Ancient Watchtower Fort",
    ...
    timings: "08:00 AM - 05:00 PM",
    routes: "Located near Rajnandgaon/Chowki borders.",
    bestTime: "October to February",
    seasonalAdvice: "Best visited in winters; summers are quite hot.",
    safety: "Wear sturdy shoes for trekking up the ancient rocky fort trail.",
    nearby: ["Dongargarh Temple"],
    localInsights: "Locals celebrate historic battles here annually.",
    ecoGuidance: "Do not touch or damage the ancient brick and stone defensive ruins.",
    biodiversityScore: 65,
    crowdCapacity: 150,
    rating: 4.3,
    localFood: "Local dhabas on the state highway.",
    photographySpots: "The bastions overlooking the vast plain borders."
  },
  {
    id: "madku-dweep",
    name: "Madku Dweep",
    ...
    coordinates: { lat: 21.6334, lng: 81.8833, mapX: 42, mapY: 48 },
    heroImage: "/sw.js",
    storyTitle: "The Island of 19 Temples",
    ...
    timings: "06:00 AM - 06:00 PM",
    routes: "Located in Mungeli district, accessible via a small bridge from the highway.",
    bestTime: "November to March",
    seasonalAdvice: "The island is most scenic in the post-monsoon months.",
    safety: "Be careful of wet clay banks near the Shivnath river crossing.",
    nearby: ["Tala Monuments"],
    localInsights: "The island is shaped like a frog, which gives it its name 'Madku'.",
    ecoGuidance: "Respect the ongoing archaeological excavations and do not climb on exposed ruins.",
    biodiversityScore: 78,
    crowdCapacity: 200,
    rating: 4.6,
    localFood: "Simple local snacks from small village stalls.",
    photographySpots: "The cluster of excavated red-brick Shivlings against the river."
  },
  {
    id: "handawada-waterfall",
    name: "Handawada Waterfall",
    category: "waterfalls",
    district: "Narayanpur",
    tagline: "The Deep Jungle Wonder of Abujhmad",
    coordinates: { lat: 19.3500, lng: 81.1833, mapX: 30, mapY: 78 },
    heroImage: "/fish_point.jpg",
    storyTitle: "Abujhmad's Secret Falls",
    ...
    routes: "Strenuous forest trek starting from Orchha block.",
    bestTime: "September to December",
    seasonalAdvice: "Monsoon rains make the trek trail extremely muddy.",
    safety: "Requires a strenuous forest trek; travel only in groups with authorized local guides.",
    nearby: ["Khursel Valley"],
    localInsights: "Local Madia tribes hold deep reverence for this waterfall.",
    ecoGuidance: "Preserve the pristine Abujhmad eco-sensitive zone; zero plastic policy.",
    biodiversityScore: 96,
    crowdCapacity: 50,
    rating: 4.9,
    localFood: "Carry dry foods and clean purification tablets.",
    photographySpots: "The massive curtain of water crashing into the deep green pool."
  },
  {
    id: "kabra-pahar",
    ...
    coordinates: { lat: 21.8833, lng: 83.4000, mapX: 78, mapY: 42 },
    heroImage: "/achanakmar.png",
    storyTitle: "The Mesolithic Rock shelters",
    ...
    timings: "07:00 AM - 05:00 PM",
    routes: "Located 15 km from Raigarh city; requires a short hike up the hill.",
    bestTime: "October to March",
    seasonalAdvice: "Rocks are less slippery in dry winter months.",
    safety: "Wear good hiking shoes for climbing the rocky steep hillside.",
    nearby: ["Ram Jharna"],
    localInsights: "Look closely for the drawing of a giant lizard, the most famous painting here.",
    ecoGuidance: "Do not touch or spray water on the ancient prehistoric drawings.",
    biodiversityScore: 72,
    crowdCapacity: 100,
    rating: 4.5,
    localFood: "Raigarh sweets available in the city.",
    photographySpots: "The rock shelter wall with the ancient ochre drawings."
  },
  {
    ...
    coordinates: { lat: 21.1667, lng: 81.7833, mapX: 52, mapY: 55 },
    heroImage: "/sirpur.png",
    storyTitle: "Chhattisgarh in a Nutshell",
    ...
    timings: "08:00 AM - 06:00 PM",
    routes: "Located in Naya Raipur; easily accessible by cab/bus.",
    bestTime: "All year round",
    seasonalAdvice: "Ideal for all ages; carry hats or umbrellas during summer afternoons.",
    safety: "Ideal for all ages; carry hats or umbrellas during summer afternoons.",
    nearby: ["Nandan Van Zoo"],
    localInsights: "Excellent place to learn about the Bastar, Surguja, and plains tribal arts in one afternoon.",
    ecoGuidance: "Help keep the cultural park clean; use designated recycling bins.",
    biodiversityScore: 70,
    crowdCapacity: 1500,
    rating: 4.8,
    localFood: "Cafeteria serving local Chhattisgarhi food like Fara and Chila.",
    photographySpots: "The entrance gate showcasing traditional murals and giant folk art sculptures."
  },
  {
    id: "maa-bambleshwari-temple",
    name: "Maa Bambleshwari Temple",
    category: "temples",
    district: "Rajnandgaon",
    tagline: "The Hilltop Shrine of Dongargarh",
    coordinates: { lat: 20.8250, lng: 80.7667, mapX: 22, mapY: 62 },
    heroImage: "/kaal_bhairav.png",
    storyTitle: "The Pilgrimage of Dongargarh",
    ...
    routes: "Dongargarh is well connected by rail; local auto rickshaws go to the hill base.",
    bestTime: "All year round (Vibrant during Navratri)",
    seasonalAdvice: "Navratri season brings heavy crowds and vibrant lights.",
    safety: "Optionally use the ropeway service to avoid climbing the 1,000+ stairs.",
    nearby: ["Ambagarh Chowki Fort"],
    localInsights: "There is also a Chhoti Bambleshwari temple at the ground level.",
    ecoGuidance: "Do not litter flowers or plastics along the hilltop path.",
    biodiversityScore: 50,
    crowdCapacity: 2000,
    rating: 4.8,
    localFood: "Pure vegetarian meals at pilgrim canteens.",
    photographySpots: "The ropeway cabin view of the temple complex perched on the cliff."
  },
  {
    id: "chandrahasini-devi-temple",
    name: "Chandrahasini Devi Temple",
    category: "temples",
    district: "Sakti",
    tagline: "The Sacred Riverside Sanctuary of Sakti",
    coordinates: { lat: 21.6983, lng: 83.2384, mapX: 74, mapY: 45 },
    heroImage: "/sw.js",
    storyTitle: "The Shrine of Chandrapur",
    ...
    timings: "06:00 AM - 09:00 PM",
    routes: "Located in Chandrapur; accessible by road from Raigarh or Sakti.",
    bestTime: "All year round",
    seasonalAdvice: "High river flows in monsoons make the banks highly scenic.",
    safety: "Be careful of slippery stone steps near the Mahanadi river ghats.",
    nearby: ["Pujaripali Temple"],
    localInsights: "The temple is located right at the confluence of Mand and Mahanadi rivers.",
    ecoGuidance: "Dispose of ritual offerings in eco-friendly bins provided near the temple.",
    biodiversityScore: 60,
    crowdCapacity: 1000,
    rating: 4.7,
    localFood: "Freshly fried river fish from local dhabas nearby.",
    photographySpots: "The colorful temple towers viewed from the Mahanadi bridge."
  },
  {
    id: "pujaripali-temple",
    name: "Pujaripali Temple Complex",
    category: "temples",
    district: "Sarangarh-Bilaigarh",
    tagline: "The Brick Monuments of Sarangarh",
    coordinates: { lat: 21.5500, lng: 83.1500, mapX: 72, mapY: 48 },
    heroImage: "/ram_tekri.png",
    storyTitle: "Ancient Brick Temples",
    ...
    timings: "07:00 AM - 06:00 PM",
    routes: "Accessible by road from Sarangarh or Raigarh.",
    bestTime: "October to March",
    seasonalAdvice: "Post-monsoon winter offers the most pleasant temperatures for exploring ruins.",
    safety: "Mind your step around loose historical stone work.",
    nearby: ["Chandrahasini Temple"],
    localInsights: "Look for the rare Chamunda Devi stone statue inside the ruins.",
    ecoGuidance: "Respect the archaeological structures; strictly no graffiti.",
    biodiversityScore: 45,
    crowdCapacity: 200,
    rating: 4.4,
    localFood: "Local roadside tea and snacks.",
    photographySpots: "The textured red brick walls of the Gopalji temple."
  },
  {
    id: "duduma-waterfall",
    ...
    coordinates: { lat: 18.5200, lng: 81.8200, mapX: 48, mapY: 92 },
    heroImage: "/tirathgarh.png",
    storyTitle: "The Machkund Canyon",
    ...
    timings: "08:00 AM - 05:00 PM",
    routes: "Accessible from Sukma or Jeypore.",
    bestTime: "September to January",
    seasonalAdvice: "Water flow is spectacular right after the monsoons.",
    safety: "Stay behind the viewpoints; the gorge has steep drop-offs.",
    nearby: ["Ramaram Temple"],
    localInsights: "The waterfall powers one of the oldest hydro-electric projects in the area.",
    ecoGuidance: "Help preserve the surrounding pristine riverine forest reserve.",
    biodiversityScore: 92,
    crowdCapacity: 150,
    rating: 4.8,
    localFood: "Snack stalls near the main parking area.",
    photographySpots: "The mist rising from the bottom of the canyon gorge."
  },
  {
    id: "kudargarh-temple",
    ...
    coordinates: { lat: 23.4500, lng: 82.9500, mapX: 62, mapY: 10 },
    heroImage: "/sw.js",
    storyTitle: "The Hilltop Shrine",
    ...
    timings: "05:00 AM - 07:00 PM",
    routes: "Located in Surajpur district; requires climbing steps.",
    bestTime: "October to April",
    seasonalAdvice: "Navratri festival time has special religious arrangements.",
    safety: "Take regular breaks while climbing the hilltop pilgrim stairs.",
    nearby: ["Tatapani Hot Springs"],
    localInsights: "A massive fair is held here during Chaitra Navratri (March/April).",
    ecoGuidance: "Keep the forest hills clean; pack your plastic water bottles back down.",
    biodiversityScore: 60,
    crowdCapacity: 1200,
    rating: 4.7,
    localFood: "Vegetarian meals at base stalls.",
    photographySpots: "The panoramic landscape of Surajpur from the hilltop temple terrace."
  },
  {
    id: "gandai-pandaria-temple",
    name: "Gandai Pandaria Shiva Temple",
    category: "temples",
    district: "Khairagarh-Chhuikhadan-Gandai",
    tagline: "An 11th-Century Architectural Gem",
    coordinates: { lat: 21.6500, lng: 81.1200, mapX: 25, mapY: 48 },
    heroImage: "/deobaloda-temple.jpg",
    storyTitle: "Kalachuri Masterpiece in Stone",
    ...
    timings: "06:00 AM - 06:00 PM",
    routes: "Located in Gandai town, accessible via road from Khairagarh.",
    bestTime: "All year round",
    seasonalAdvice: "Perfect to visit during winter months.",
    safety: "Mind the low doorways while exploring the stone sanctum.",
    nearby: ["Dongargarh Temple"],
    localInsights: "The temple features carvings of mythological themes.",
    ecoGuidance: "Preserve the ancient stone carvings; do not touch or deface the structures.",
    biodiversityScore: 40,
    crowdCapacity: 150,
    rating: 4.6,
    localFood: "Local tea and snacks from highway stalls.",
    photographySpots: "The exterior stone pillars showing the fine Kalachuri style."
  }
];
